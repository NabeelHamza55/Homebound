            ...
            <div class="login-box">
                ...
                <form class="login-form" method="post" action="{{ route('login.process') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" name="email" placeholder="mail@gmail.com" required="email">
                        <i class="user-icon"></i>
                        @error('email')
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password" name="password" placeholder="Enter password" required="password">
