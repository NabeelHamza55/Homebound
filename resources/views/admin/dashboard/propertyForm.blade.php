    ...
    <div class="dashboard-column right-content">
            ...
            <div class="right-head-button d-flex align-items-center">
                {{-- <div class="dropdown bell-dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="{{ route('admin.property.create') }}">Add Property</a></li>
                        <li><a class="dropdown-item" href="{{ route('search.property') }}">Search Property</a>
                        </li>
                    </ul>
                </div> --}}
            </div>
        ...
        <div class="dashboard-content">
            <div class="add-properties">
                @if (!empty($data))
                    <form action="{{ route('admin.property.create.save') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 form-group">
                                ...
                                <input type="text" class="form-control upload-property-form" name="city"
                                    value="{{ $data->city }}" placeholder="City here" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 form-group">
                                <h5 class='lbl'>State</h5>
                                <input type="text" class="form-control upload-property-form" name="state"
                        ...
                        <div class="row">
                            <div class="col-lg-12 upload-property-button d-flex">
                                <button onclick="window.location='{{ route('user.dashboard') }}'"
                                    class="btn cst-res-button">Back</button>
                    ...
                    <form action="{{ route('admin.property.create.save') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 form-group">
                                <h5 class='lbl'>City</h5>
                                <input type="text" class="form-control upload-property-form" name="city"
                                    value="" placeholder="City here" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".add-file-input").click(function() {
                ...
                fileInput +=
                    '<div style="" class="inner-upload-property  mx-2 preview-container" id="preview-container-' +
                    count + '">';
                fileInput += '<input style="max-width: 72rem;padding-top: 2rem;" id="add-file-input-' +
                    count +
                    '" type="file" accept=".jpg, .jpeg, .png" class="hide-field" name="home_picture_input[]">';
                fileInput += '<img src="{{ asset('images/camera.png') }}">';
                fileInput += '<span>Add Property</span>';
                fileInput += '</div>';
                fileInput +=
                    '<button style="height: 2.2rem;" type="button" class="remove-file-input btn btn-danger">-</button>';
                fileInput += '</div>';
                fileInput += '</div>';
            ...
            $("#file-input-container").on('click', '.remove-file-input', function() {
                var clickedCount = $(this).closest('.file-input-group').find('input[type="file"]').attr(
                    'id').split('-')[3];
                ...
                $("#add-file-input-" + currentCount).change(function() {
                    ...
                    for (var i = 0; i < files.length; i++) {
                        ...
                        reader.onload = function(e) {
                            ...
                            var previewDiv = $(
                                '<div class="inner-upload-property mx-2 mt-5"><img class="new-img" src="' +
                                e.target.result + '" alt="Preview"></div>');
