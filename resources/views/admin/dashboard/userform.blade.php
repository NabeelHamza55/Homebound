            ...
            <div class="add-properties">
                {{-- <div class="upload-property">
                    <div style="width: 175px; margin-top: 1rem;background-color: transparent;"
                        ...
                        <img style="max-height: 100%;border-radius: 12px;" src="{{ asset('/ProfilePicture/') }}">
                    </div>
                </div> --}}
                <form action="{{ route('admin.user.save', $role) }}" method="post" enctype="multipart/form-data"
                    class="upload-property-form">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 col-md-6 form-group">
                            <label class="ms-2">Chose new Profile Picture</label>
