                ...
                <div class="dashboard-content">
                    <div class="add-properties">
                        <div class="upload-property">
                            <div style="width: 175px; margin-top: 1rem;background-color: transparent;" class="inner-upload-property">
                                <img style="max-height: 100%;border-radius: 12px;" src="{{ asset('/ProfilePicture/'.$user->profile_picture) }}">
                            </div>
                        </div>
                        <form action="{{route('update.profile')}}" method="post" enctype="multipart/form-data" class="upload-property-form">
                            @csrf
                            <!--<div class="row">-->
