...
<body>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
              <div class="navbar-header logo">
                <a class="navbar-brand" href="{{route('user.dashboard')}}"><img src="{{asset('images/logo.png')}}"></a>
              </div>
              <div class="nav navbar-nav header-buttons">
                <a href="" class="back-button">Back</a>
                <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" class="add-to-cart-button">Add to Cart</a>
            ...
            <div style="top: 14.5rem;" class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <p class="pb-3">Congratulations on completing your book! Secure your item now and
                        ...
                        <a id="add_to_cart" href="{{ route('add.to.cart.item', $book->id) }}" class="social-button mt-5">Add to Cart</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="image-section">
        <div class="owl-carousel owl-theme image-slide1">
            ...
            <div class="slide"><img
                    src="{{ $book['front_page'] }}"
                    alt="Front Side"> <p>Front Side</p></div>
            @endif
            @endif
            ...
            <div class="slide"><img
                    src="{{ $book['spine_page'] }}"
                    alt="Spine Side"> <p>Spine Side</p></div>
            @endif
            @endif
            ...
            <div class="slide"><img
                    src="{{ $book['back_page'] }}"
                    alt="Back Side"> <p>Back Side</p></div>
            @endif
            @endif
